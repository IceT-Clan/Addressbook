...
namespace Addressbook {
    ...
    class View {
        ...
        public Person Add_Entry() {
            ...
            Console.WriteLine("┃" + offsetFromBorderXstr + ("Birth Data: ")); person.Birth_data = Input_BirthData();  Console.WriteLine(person.Birth_data.ToShortDateString().PadRight(100).Substring(0, borderWidth - 2) + "┃");
        ...
        public DateTime Input_BirthData() {
